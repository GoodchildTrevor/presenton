...
# URL-заглушка для изображений при генерации HTML-шаблонов.
# Переопределяется через переменную окружения TEMPLATE_PLACEHOLDER_IMAGE_URL.
TEMPLATE_PLACEHOLDER_IMAGE_URL = os.getenv(
    "TEMPLATE_PLACEHOLDER_IMAGE_URL",
...
- For image everywhere use {TEMPLATE_PLACEHOLDER_IMAGE_URL}
