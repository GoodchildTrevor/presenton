    ...
    <div className="min-h-screen font-roboto bg-gradient-to-br from-slate-50 to-slate-100">
      ...
      <div className="flex items-center justify-center aspect-video mx-auto px-6">
        <div className="text-center space-y-2 my-6 bg-white p-10 rounded-lg shadow-lg">
          ...
          Please configure Ollama to enable template creation via AI.
          </h1>
          <h1 className="text-xl font-bold text-gray-900">Please configure your Ollama model to process the layout</h1>
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            This feature requires an Ollama model. Configure your model in settings or via environment variables.
          </p>
        </div>
      </div>
    </div>
